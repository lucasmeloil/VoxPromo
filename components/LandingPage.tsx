...
import { SparklesIcon } from '@heroicons/react/24/solid'; // Importe os ícones que você usa
        ...
        <div id="landing-page" className="min-h-screen flex flex-col items-center p-4 relative overflow-hidden">
            ...
            <div className="z-10 w-full max-w-sm sm:max-w-md mx-auto space-y-8 py-12 text-center">
                ...
                <div className="flex flex-col gap-4 mt-8 animate-fade-in-up delay-600">
                    <button onClick={onStartApp} className="glowing-button relative inline-flex items-center justify-center p-0.5 overflow-hidden rounded-full group hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-lg flex flex-col justify-between transform transition-all duration-300 hover:scale-105 hover:border-purple-600">
                        <div>
                            ...
                            <ul className="flex flex-col items-start space-y-3 mb-6 px-4">
                                <li className="flex items-center text-gray-400 text-base"><SparklesIcon className="w-5 h-5 mr-3 text-purple-400" /> 1 Criação Gratuita por Mês</li>
                                ...
                                <li className="flex items-center text-gray-400 text-base"><SparklesIcon className="w-5 h-5 mr-3 text-purple-400" /> Histórico de criações</li>
                            </ul>
                        </div>
                        <button onClick={onStartApp} className="mt-auto bg-purple-600 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 text-base w-full">
                            Comece Grátis!
                        </button>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-yellow-700 to-amber-900 p-6 rounded-xl border border-yellow-500 shadow-2xl premium-glow flex flex-col justify-between transform transition-all duration-300 hover:scale-105">
                        <div>
                            ...
                            <p className="text-xl font-extrabold text-yellow-300 text-center mb-2">R$ 14,90 <span className="text-lg font-normal text-yellow-200">/ mês</span></p>
                        ...
                        <button onClick={onStartApp} className="mt-auto bg-white text-purple-900 font-bold py-3 px-6 rounded-full shadow-lg hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 text-base w-full">
