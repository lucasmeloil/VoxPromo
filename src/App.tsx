...
import CreateAd from './views/CreateAd.tsx';
import History from './views/History.tsx';
import Profile from './views/Profile.tsx';
import LandingPage from './components/LandingPage.tsx';
import PaymentPage from './views/PaymentPage.tsx'; // New import for initiating payment
import PaymentConfirmationPage from './views/PaymentConfirmationPage.tsx'; // Renamed and refactored
import Login from './views/Auth/Login.tsx';
import Register from './views/Auth/Register.tsx';
import ForgotPassword from './views/Auth/ForgotPassword.tsx';
import AdminPanel from './views/AdminPanel.tsx'; // New import for Admin Panel
// fix: add file extensions to imports
import { AdHistoryItem, CurrentView, AdPromptConfig } from './types.ts';
  ...
  if (isLoadingAuth) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
        <svg className="animate-spin h-10 w-10 text-purple-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 24">
